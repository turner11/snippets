...
Detailed code smell catalog, extract-method patterns, type-safety guidance, design patterns, and operation examples.
Loaded when refactoring specific smells or patterns.
